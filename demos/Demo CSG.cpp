...
int main()
{
    ...
    //Floor
    scene.add(std::make_shared<CCompositeGeometry>(pShaderRed, CSolidCylinder(pShaderBlue, Vec3f(5, 0, 0),1.5, 5), CSolidCylinder(pShaderRed, Vec3f(4, 0, 0), 1.2, 5), rt::Intersection));
