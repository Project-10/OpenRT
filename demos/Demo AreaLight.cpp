...
int main()
{
	...
	// Shaders
	//auto pShaderGlobal	= std::make_shared<CShaderGlobal>(scene, RGB(255, 255, 255), std::make_shared<CSamplerStratified>(7, true));
	...
	auto pLightRed		= std::make_shared<CLightArea>(RGB(intensity, 0, 0 ), Vec3f(0.5f, 0, 3), Vec3f(-0.5f, 0, 3), Vec3f(-0.5f, 10, 3), Vec3f(0.5f, 10, 3), std::make_shared<CSamplerStratified>(4, true));
	auto pLightGreen	= std::make_shared<CLightArea>(RGB(0, intensity, 0), Vec3f(2.47f, 0, 1.77f), Vec3f(1.77f, 0, 2.47f), Vec3f(1.77f, 10, 2.47f), Vec3f(2.47f, 10, 1.77f), std::make_shared<CSamplerStratified>(4, true));
	auto pLightBlue		= std::make_shared<CLightArea>(RGB(0, 0, intensity), Vec3f(3, 0, -0.5f), Vec3f(3, 0, 0.5f), Vec3f(3, 10, 0.5f), Vec3f(3, 10, -0.5f), std::make_shared<CSamplerStratified>(4, true));
	...
	Mat img = scene.render(std::make_shared<CSamplerStratified>(4, true), 48);
	Timer::stop();
