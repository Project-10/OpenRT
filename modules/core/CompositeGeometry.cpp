...
rt::CCompositeGeometry::CCompositeGeometry(const rt::ptr_shader_t &pShader,
                                           ...
                                           rt::OperationType operationType) : CCompositeGeometry(pShader, s1,
                                                                                                 CSolid(p2),
                                                                                                 operationType) {
}

rt::CCompositeGeometry::CCompositeGeometry(const rt::ptr_shader_t &pShader, const rt::ptr_prim_t &p1,
                                           const rt::ptr_prim_t &p2,
                                           rt::OperationType operationType) : CCompositeGeometry(pShader, CSolid(p1),
                                                                                                 CSolid(p2),
                                                                                                 operationType) {
}