...
TEST_F(CTestBoundingBox, solid_sphere) {
    ...
    auto pShaderSphere = std::make_shared<CShaderEyelight>(RGB(1, 1, 1));
    ...
    ptr_prim_t 	pComposite = std::make_shared<CCompositeGeometry>(solidSphere1, solidSphere2, BoolOp::Union);
